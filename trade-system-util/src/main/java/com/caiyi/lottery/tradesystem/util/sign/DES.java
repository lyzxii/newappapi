...
public class DES {
	...
	public static String key(String seed) throws Exception {
		...
		byte[] keyBase64EncodeStringArr = Base64.encode(bytes);

		String keyBase64EncodeString = new String(keyBase64EncodeStringArr);
	...
	public static String encrypt(String text, String key, String charset)
		...
		byte[] encryptBase64EncodeStringArr = Base64.encode(bytes);//base64编码
		String encryptBase64EncodeString = new String(encryptBase64EncodeStringArr);
