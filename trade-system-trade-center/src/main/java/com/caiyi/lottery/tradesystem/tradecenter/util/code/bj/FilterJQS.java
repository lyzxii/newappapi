...
public class FilterJQS extends FilterBase{
	...
	public void filter(CodeBean bean, FilterResult result) throws CodeFormatException {
		//北单进球数玩法，单式上传时，兼容加号。例如 22→4,25→2,26→2,28→7+,29→3 转换为 22→4,25→2,26→2,28→7,29→3
		if (bean != null && bean.getCode() != null && bean.getCode().trim().length() > 0) {
...
//		String gg = len + "*1";
	...
	public static void main(String[] args) {
		...
		ylist.add("[总进球数]18=1/2/3/4,19=2/3/4/5,21=2/3/4/5|3*1");
